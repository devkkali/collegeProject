...
(function (MatchRoute) {
    ...
    MatchRoute.Index.get("/admin/match", [match_controller_js_1.MatchController.GetMatch]);
    MatchRoute.Index.get("/admin/match/:id", [match_controller_js_1.MatchController.GetMatch]);
